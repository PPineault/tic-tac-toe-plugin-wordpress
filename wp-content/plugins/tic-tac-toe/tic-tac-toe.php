...
function enqueueFiles()
{
    ...
    wp_register_style('TIC_TAC_TOE_FONT_AWESOME', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css');
    wp_enqueue_style('TIC_TAC_TOE_FONT_AWESOME');
}
